		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="position-relative w-100">
					<input type="search" class="form-control form-control-sm w-100" id="msearch"
						placeholder="Enter music title or artist" autocomplete="off">
					<div class="position-absolute w-100" id="suggest"
						style="z-index:5;max-height: 50vh;overflow: auto;display:none">
						<ul class="list-group">
				...
				<tbody>
					...
					while ($row = $items->fetch_assoc()):
						...
						<tr data-id='<?php echo $row['music_id'] ?>'>
							<td><span
									class="btn bg-gradient-success rounded-circle d-flex justify-content-center align-items-center"
							...
							<td><input name='music_id[]' value='<?php echo $row['music_id'] ?>' type='hidden'><i
									class='fa fa-music text-gradient-primary mr-2'></i>
								<?php echo $row['title'] ?>
							</td>
							<td class='text-right'><button type='button' onclick='$(this).closest("tr").remove()'
...
<div id="list_clone" class="d-none">
	<li class="list-group-item suggest-item">
		<div id="pdet" class="d-flex justify-content-between align-items-center">
			<div class="d-flex">
				<img src="assets/uploads/play.jpg" alt="" class="img-thumbnail bg-gradient-1"
					style="width: 50px;height: 50px;object-fit: cover">
				<div class="ml-2 mr-4">
					<div><b>
							<large class="mtitle">Title</large>
						</b>
					</div>
					<div>
			...
			<span class="btn bg-gradient-success bp rounded-circle d-flex justify-content-center align-items-center"
				style="width:30px;height:30px;z-index:2">
				<div class="fa fa-play text-white"></div>
			</span>
	</li>
