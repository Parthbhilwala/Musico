				...
				<div id="msg"></div>
					...
					<div class="col-md-6">
							<div class="form-group">
								<input type="text" name="contact"   maxlength="10" class="form-control form-control-sm"  placeholder="Contact">
							</div>
							<div class="form-group">
    ...
    $('#signup').submit(function(e){
        ...
        $('#signup input, #signup textarea').each(function() {
            if ($(this).val().trim() === '') {
                ...
                $(this).removeClass('is-invalid'); // Remove highlighting if field is filled
            }
        });

        if (!isValid) {
            $('#msg').html("<div class='alert alert-danger'>Please fill all fields.</div>");
