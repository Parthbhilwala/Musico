...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper mx-0  bg-dark">
      ...
      <section class="content">
          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                ...
                ?>
                <h1 class="m-0 text-gradient-primary">
                  <?php echo $title ?>
                </h1>
              </div><!-- /.col -->
        ...
        <div id="audio-player"
          class="d-flex w-100 justify-content-end align-items-center bg-dark py-1 position-absoulute">

          <button class="btn prev-player audio-control-btn" onclick="_prev($(this))" data-type="play"><i
              class="fa fa-step-backward"></i></button>
          <button class="btn p-player audio-control-btn" onclick="_player($(this))" data-queue="0" data-type="play"
            style="font-size: 25px"><i class="fa fa-play"></i></button>
          <button class="btn next-player audio-control-btn" onclick="_next(-1,1)" data-type="play"><i
      ...
      <div class="text-dark">
        ...
        <div class="modal fade" id="uni_modal" role='dialog'>
          <div class="modal-dialog modal-md mt-3" role="document">
            <div class="modal-content">
              <div class="modal-header">
