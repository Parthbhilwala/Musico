...
<style>
  ...
  width: 94%;
	...
	.bg-new1{
		background-color: #7544b766 !important;
	}
  	...
  	<div class="container">
  		...
  		<div id="login-center" class="row justify-content-center align-self-center w-100">
  			<div class="d-flex justify-content-center align-items-center w-100">
  				...
  				<h2 class="text-gradient-primary"><b>Music </b></h2>
  				</span>
  			</div>
  			<div class="card bg-new1 col-sm-7">
  				<div class="card-body">
  					<form id="login-form" >
  						<div class="form-group"><i
              class="fa fa-envelope" style="color:white"></i>
  							<input type="text" id="email" name="email" class="form-control" placeholder="Email">
  						</div>
  						<div class="form-group"><i
              class="fa fa-key" style="color:white"></i>
...
<a  id="manage_my_account" style="color: white;" href="forgot.php"><i
              class="fa fa-key"></i> Forget Password
            </a>
