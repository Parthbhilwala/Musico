...
<div class="container-fluid">
	<form action="" id="update-account" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group d-flex justify-content-center">
						<img src="assets/uploads/<?php echo isset($profile_pic) ? $profile_pic : '' ?>" alt=""
							id="cover" class="img-fluid img-thumbnail">
					</div>
					...
					<div class="form-group">
						...
						<?php if ($_SESSION['login_type'] == 2): ?>
							<a href="payment.php">
								<img src="img/5.png"
									style="width: 100px; height: 100px; margin-top :10px; margin-left :20px;"></a>
